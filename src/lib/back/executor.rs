...
fn convert_to_value<'a>(func:&Function<'a>, val:&'a JITVal<'a>) -> JITVal<'a> {
    ...
    if val_kind.contains(SysBool) || val_kind.contains(UByte) {
        ...
        let sig = get_type::<fn(bool) -> *mut int>();
        ...
        if ref_t.get_kind().contains(SysChar) {
            ...
            let sig = get_type::<fn(String) -> *mut int>();
            ...
            let sig = get_type::<fn(&i8) -> *mut int>();
        ...
        let sig = get_type::<fn(i32) -> *mut int>();
        ...
        let sig = get_type::<fn(int) -> *mut int>();
        ...
        let sig = get_type::<fn(f64) -> *mut int>();
